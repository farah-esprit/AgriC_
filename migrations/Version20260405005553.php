 ...
 */
final class Version20260405005553 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande ADD prix_total DOUBLE PRECISION DEFAULT NULL, CHANGE date_commande date_commande VARCHAR(255) DEFAULT NULL, CHANGE statut statut VARCHAR(255) DEFAULT NULL, CHANGE quantite_commandee quantite_commandee INT DEFAULT NULL, CHANGE id_produit id_produit INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD numero VARCHAR(20) NOT NULL, ADD etat_compte VARCHAR(50) DEFAULT NULL, DROP etatCompte, DROP two_factor_secret, DROP two_factor_enabled, DROP verification_code, DROP code_expiration, CHANGE nom nom VARCHAR(255) NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE role role VARCHAR(50) DEFAULT NULL, CHANGE date_creation date_creation DATETIME DEFAULT NULL, CHANGE motDePasse mot_de_passe VARCHAR(255) NOT NULL');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649F55AE19E ON user (numero)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande DROP FOREIGN KEY FK_6EEAA67DF7384557');
        $this->addSql('ALTER TABLE commande DROP FOREIGN KEY FK_6EEAA67DA76ED395');
        $this->addSql('ALTER TABLE commande DROP prix_total, CHANGE id_produit id_produit BIGINT DEFAULT NULL, CHANGE date_commande date_commande DATETIME NOT NULL, CHANGE statut statut VARCHAR(20) NOT NULL, CHANGE quantite_commandee quantite_commandee INT NOT NULL');
        ...
        $this->addSql('DROP INDEX UNIQ_8D93D649F55AE19E ON user');
        $this->addSql('ALTER TABLE user ADD etatCompte VARCHAR(255) DEFAULT \'ACTIF\', ADD two_factor_secret VARCHAR(255) DEFAULT NULL, ADD two_factor_enabled TINYINT(1) DEFAULT 0, ADD verification_code VARCHAR(10) DEFAULT NULL, ADD code_expiration DATETIME DEFAULT NULL, DROP numero, DROP etat_compte, CHANGE nom nom VARCHAR(100) NOT NULL, CHANGE email email VARCHAR(100) NOT NULL, CHANGE role role VARCHAR(255) NOT NULL, CHANGE date_creation date_creation DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE mot_de_passe motDePasse VARCHAR(255) NOT NULL');
