 ...
 */
final class Version20260421003933 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE note_evenement (id INT AUTO_INCREMENT NOT NULL, valeur INT NOT NULL, created_at DATETIME NOT NULL, evenement_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_1C818D81FD02F13 (evenement_id), INDEX IDX_1C818D81A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('ALTER TABLE note_evenement ADD CONSTRAINT FK_1C818D81FD02F13 FOREIGN KEY (evenement_id) REFERENCES evenement (id_evenement) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE note_evenement ADD CONSTRAINT FK_1C818D81A76ED395 FOREIGN KEY (user_id) REFERENCES user (user_id)');
        ...
        $this->addSql('ALTER TABLE evenement CHANGE titre titre VARCHAR(150) DEFAULT NULL, CHANGE description description LONGTEXT DEFAULT NULL, CHANGE date_debut date_debut DATETIME DEFAULT NULL, CHANGE date_fin date_fin DATETIME DEFAULT NULL, CHANGE lieu lieu VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE reclamation CHANGE objet objet VARCHAR(100) DEFAULT NULL, CHANGE description description LONGTEXT DEFAULT NULL, CHANGE date_creation date_creation DATETIME DEFAULT NULL, CHANGE statut statut VARCHAR(20) DEFAULT NULL, CHANGE priorite priorite VARCHAR(20) DEFAULT NULL, CHANGE type type VARCHAR(50) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE note_evenement DROP FOREIGN KEY FK_1C818D81FD02F13');
        $this->addSql('ALTER TABLE note_evenement DROP FOREIGN KEY FK_1C818D81A76ED395');
        $this->addSql('DROP TABLE note_evenement');
        $this->addSql('ALTER TABLE activity CHANGE end_at end_at DATETIME DEFAULT \'NULL\'');
